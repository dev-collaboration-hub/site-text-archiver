...
| URL resolution and canonicalization | M1 | `ALGORITHMS_AND_PSEUDOCODE.md`, `API_MESSAGE_DATA_CONTRACTS.md` | `src/url/` | URL equivalence and rejection-reason tests | Documented |
| Origin and path scope enforcement | M1 | `PROJECT_SPECIFICATION.md`, `MODULE_SPECIFICATIONS.md` | `src/url/` | Out-of-scope and unsafe-link tests | Documented |
| Duplicate URL registry | M1 | `ALGORITHMS_AND_PSEUDOCODE.md` | `src/url/` or crawl state | Circular and duplicate URL tests | Documented |
...
Working product: M0 early foundation
Current implementation target: M1 URL Intelligence and Safety
```
